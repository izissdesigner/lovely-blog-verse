...
const Panchang = () => {
  ...
  useEffect(() => {
    // In a real app, this would fetch data from Supabase or an external API
    fetchPanchangData();
  }, [currentDate]);
  ...
  const fetchPanchangData = async () => {
    try {
      ...
      if (data && !error) {
        ...
        // If no data found, use mock data (in real app, this would call external API)
        console.log('Using mock panchang data');
      }
    } catch (error) {
